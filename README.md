...
- Tablestore Endpoint URL (e.g., `https://instance-name.cn-hangzhou.ots.aliyuncs.com`)
...
|-----------|-------------|---------|
| Tablestore Endpoint | Endpoint URL of the Tablestore instance | `https://xxx.ots.aliyuncs.com` |
