...
- Tablestore Endpoint URL (e.g., `https://instanceName.RegionID.ots.aliyuncs.com`)
...
|-----------|-------------|---------|
| Tablestore Endpoint | Endpoint URL of the Tablestore instance | `https://instanceName.RegionID.ots.aliyuncs.com` |
